...
namespace FarmFresh.Infrastructure.Data.Migrations
{
    ...
    [Migration("20231024053848_updateOf")]
    partial class updateOf
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FarmFresh.Domain.Entities.Products.ProductHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FarmFresh.Domain.Entities.Users.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FarmFresh.Domain.Entities.Users.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FarmFresh.Domain.Entities.Users.RefreshToken", b =>
                {
                    b.HasOne("FarmFresh.Domain.Entities.Users.User", "User")
                        ...
                        .HasForeignKey("FarmFresh.Domain.Entities.Users.RefreshToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
