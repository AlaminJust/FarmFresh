...
namespace FarmFresh.Infrastructure.Data.Migrations
{
    ...
    [Migration("20221114012845_AddSeedValueForProductCategory")]
    partial class AddSeedValueForProductCategory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductProductBrand", b =>
                {
                    ...
                    b.HasKey("ProductBrandsId", "ProductsId");

                    b.HasIndex("ProductsId");

                    b.ToTable("ProductProductBrand", "dbo");
                });
            ...
            modelBuilder.Entity("ProductProductBrand", b =>
                {
                    b.HasOne("FarmFresh.Domain.Entities.Products.ProductBrand", null)
                        .WithMany()
                        .HasForeignKey("ProductBrandsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FarmFresh.Domain.Entities.Products.Product", null)
                        .WithMany()
